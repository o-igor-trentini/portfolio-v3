    ...
    (
      ...
      >
        ...
        >
          ...
          >
            <div style={{ display: "flex", width: 13, height: 13, borderRadius: 999, background: "#3f3f46" }} />
            <div style={{ display: "flex", width: 13, height: 13, borderRadius: 999, background: "#3f3f46" }} />
            <div style={{ display: "flex", width: 13, height: 13, borderRadius: 999, background: accent }} />
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 18, padding: "56px 60px" }}>
            <div style={{ display: "flex", color: accent, fontSize: 82, fontWeight: 700, letterSpacing: -2 }}>
              {siteConfig.name}
            </div>
            <div style={{ display: "flex", color: FG, fontSize: 40 }}>
              {`> ${t.hero.role}`}
            </div>
